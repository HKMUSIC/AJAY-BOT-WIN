...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/HKMUSIC/AJAY-BOT-WIN",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHAT", "https://t.me/updtes_group")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/updtes_group")
